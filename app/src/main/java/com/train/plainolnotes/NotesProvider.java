...
public class NotesProvider extends ContentProvider {
    ...
    private static final String AUTHORITY = "com.train.plainolnotes.notesprovider";
    ...
    static {
        ...
        uriMathcer.addURI(AUTHORITY, BASE_PATH, NOTES);
        uriMathcer.addURI(AUTHORITY, BASE_PATH + "/#", NOTES_ID);
    }
